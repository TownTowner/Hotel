...
{
    public static IServiceCollection AddHotelConsulServiceRegistration(this IServiceCollection services,string consulUrl)
    {
        services.AddConsul(op => op.Address = new Uri(consulUrl));
